...
import animal from "../icons/animal.svg"
 ...
 export function Productsmenus(){
    ...
    return(
      ...
      <div className={eqstyle.prodmenu}><a className={eqstyle.iconname} href="/">
      <div className={eqstyle.icon_round}><img className={eqstyle.chicksicon} src={animal}/></div>
      <div className={eqstyle.bxaligh} ><p className={eqstyle.chname}>Home </p>
      <p className={eqstyle.sortMenuInfo}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. </p></div></a></div>
